...
def banner():
    print('''\033[1;95m                                                                                                                  
                                                     ...
                                                     ╚██████╗ ██    ██ ██║  ██║╚██████╗ ██║  ██╗
                                                      ╚═════╝ ╚═════╝  ╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝
    \033[0m\n''')
    print('\033[1;77mCreado por Mario\033[0m\n')
...
# Define la ruta del archivo usando os.path.join para mayor portabilidad
PASSWORD_FILE = os.path.join("C:\\", "Users", "Mario", "Desktop", "documentos programas", "FcCracker", "passwords.txt")
...
if __name__ == "__main__":
    ...
    print('\n---------- Thank our @Whoam4 for this tool! ----------\n')
    print("Current working directory:", os.getcwd())  # Verificación del directorio actual
